...
class HaikuGeneratorBackendPipelineStack(Stack):
    def __init__(self, scope: Construct, construct_id: str,
        ...
        backend_pipeline = codepipeline.Pipeline(
            self, "Pipeline",
            pipeline_name="haiku-generator-backend",
                ...
                codepipeline_actions.CodeBuildAction(
                    ...
                    project=codebuild.PipelineProject(
                        ...
                        build_spec=codebuild.BuildSpec.from_object({
                            ...
                            "artifacts": {
                                "files": ["aws/haiku-generator-backend/imagedefinitions.json"]
                            }
                        })
                    ),
        ...
        backend_pipeline.add_stage(
            ...
            actions=[
                codepipeline_actions.EcsDeployAction(
                    ...
                    image_file=backend_build_output.at_path("aws/haiku-generator-backend/imagedefinitions.json")
                )
            ]
        )