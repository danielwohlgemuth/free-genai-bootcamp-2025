    ...
    <div className="summary-display">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="japanese-haiku">
          {haiku.haiku_line_ja_1 && <p>{haiku.haiku_line_ja_1} <AudioPlayer audioLink={haiku.audio_link_1} /></p>}
          {haiku.haiku_line_ja_2 && <p>{haiku.haiku_line_ja_2} <AudioPlayer audioLink={haiku.audio_link_2} /></p>}
          {haiku.haiku_line_ja_3 && <p>{haiku.haiku_line_ja_3} <AudioPlayer audioLink={haiku.audio_link_3} /></p>}
        </div>
